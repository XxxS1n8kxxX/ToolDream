...
<body>
    ...
    <div id="page-content-wrapper">
        ...
        <h1 style="padding: 10px">Cambiar Email de Usuario</h1>

        <form action="cambiar-email.php" method = "post">

        <h5 class = "text-primary" style = "margin-left: 10px">Nuevo Email</h5>

        <input style = "margin-left: 10px" class="border border-primary" type="text" name="nuevo_email_usuario"><br><br>
        <input style = "margin-left: 10px" class="btn btn-secondary bg-primary text-center" type="submit" value="Cambiar Email de Usuario">
