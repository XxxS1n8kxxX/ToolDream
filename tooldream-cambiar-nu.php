...
<body>
    ...
    <div id="page-content-wrapper">
        ...
        <h1 style="padding: 10px">Cambiar Nombre de Usuario</h1>

        <form action="cambiar-nu.php" method = "post">

        <h5 class = "text-primary" style = "margin-left: 10px">Nuevo nombre</h5>

        <input style = "margin-left: 10px" class="border border-primary" type="text" name="nuevo_nombre_usuario"><br><br>
        <input style = "margin-left: 10px" class="btn btn-secondary bg-primary text-center" type="submit" value="Cambiar nombre de usuario">
