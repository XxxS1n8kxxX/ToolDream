    ...
    <div id="page-content-wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
            <div class="container-fluid">
                ...
                <h5 style = "float: left; margin-left: 15px; margin-top: 12px; margin-right: 10px" class = "text-danger"><?php if(isset($_SESSION['cambios'])){ echo $_SESSION['cambios']; unset($_SESSION['cambios']);}?></h5>

                <div>
                    <form action="tooldream.php" method="post">
                        <input type="text" name="busqueda">
                        <input class="btn-primary rounded"  type="submit" value="Buscar Canción">
                    </form>
                </div>
        ...
        <div id="canciones">
            ...
            if(isset($_REQUEST["busqueda"])){
              ...
              $select_canciones = "SELECT * FROM songs s inner join album a on a.ID_ALBUM = s.ID_ALBUM  WHERE s.OWNER_SONG = '$user_td' AND s.URL_SONG LIKE '%$busqueda%' order by a.ARTIST asc";

              $result_comprobador = mysqli_query($conn,$select_canciones);

              $comprobador = mysqli_num_rows($result_comprobador);
        ...
        <h1 style="padding: 10px">Usuario</h1>

        <?php

          $select_user = "SELECT NAME_USER, EMAIL, IMG FROM USER_BD WHERE NAME_USER = '$user_td'";
          ...
          while($row = mysqli_fetch_array($result_user, MYSQLI_ASSOC)){
              ...
              "
              <img style='height:200px; float: right; margin-top: -60px; margin-right: 100px;' class='img-fluid rounded' src='usuarios/$user_td" . "/img_perfil/{$row['IMG']}'/>
              ...
              <table class='table-albumes'>
                <thead class='thead-primary bg-primary text-white rounded'>
                  <tr>
                    ...
                    <th scope=>&nbsp {$row['NAME_USER']} &nbsp</th>
                  </tr>
                </thead>
              </table>
              ...
              <table class='table-albumes'>
                <thead class='thead-primary bg-primary text-white rounded'>
                  <tr>
                    <th scope='col'>&nbsp Email &nbsp</th>
                    <th scope=>&nbsp {$row['EMAIL']} &nbsp</th>
                  </tr>
                </thead>
              </table>
          ...
          <div id="alinear_form_cambio_img_user" style='height:200px; float: right; margin-top: 5px;'>

          <form action="add_img_user.php" method="post" enctype="multipart/form-data">
          ...
          <div id="padding-submit-img-user" style='margin-left: 100px;'><input class="btn btn-secondary bg-primary text-center" type="submit" value="Cambiar Foto de Perfil"></div>
          ...
          <form action="tooldream-cambiar-nu.php" method="post">

            <button class="btn btn-secondary bg-primary text-center boton-1-1-1">Cambiar nombre</button>

          </form>

          </div>

          <div style = "float: left; margin-left: 160px; margin-top: -70px;">

          <form action="tooldream-cambiar-email.php" method="post">

            <button style = "float: left; margin-left: 10px;" class="btn btn-secondary bg-primary text-center boton-1-1-2">Cambiar email</button>

          </form>

          </div>

          <div style = "float: left; margin-left: 305px; margin-top: -70px;">

          <form action="tooldream-cambiar-pass.php" method="post">

            <button style = "float: left; margin-left: 10px;" class="btn btn-secondary bg-primary text-center boton-1-1-3">Cambiar contraseña</button>
          ...
          <form action="eliminar_cuenta.php" method="post">
            ...
            <button style = "float: left; padding: 10px; margin-top: 410px; margin-left: -300px;" class="btn btn-danger bg-danger text-center boton-1-1-3">Eliminar cuenta</button>
